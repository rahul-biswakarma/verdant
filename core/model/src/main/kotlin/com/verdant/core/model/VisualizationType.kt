...
fun TrackingType.defaultVisualization(): VisualizationType = when (this) {
    ...
    TrackingType.EMOTIONAL -> VisualizationType.RPG_RADAR
    TrackingType.EVENT_DRIVEN -> VisualizationType.PIXEL_GRID
...
fun VisualizationType.recommendedFor(): Set<TrackingType> = when (this) {
    VisualizationType.PIXEL_GRID -> setOf(TrackingType.BINARY, TrackingType.LOCATION, TrackingType.EVENT_DRIVEN)
    ...
    VisualizationType.RPG_RADAR -> setOf(TrackingType.EMOTIONAL, TrackingType.QUANTITATIVE)
}
